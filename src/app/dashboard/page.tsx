                ...
                <div className="p-6">
                  ...
                  <div className="mb-5">
                    <div className="flex justify-between mb-2 text-sm">
                      ...
                      <span className="text-gray-700 dark:text-gray-300 font-semibold">24/32 topics</span>
                    </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md dark:shadow-gray-900/10 overflow-hidden transition-all duration-300 hover:shadow-xl dark:hover:shadow-gray-900/20 border border-gray-100 dark:border-gray-700 hover:border-green-200 dark:hover:border-green-800 group">
                <div className="p-6">
                  ...
                  <div className="mb-5">
                    <div className="flex justify-between mb-2 text-sm">
                      <span className="text-gray-500 dark:text-gray-400 font-medium">Progress</span>
                      <span className="text-gray-700 dark:text-gray-300 font-semibold">18/29 topics</span>
                    </div>
                    <div className="w-full h-3 bg-gray-100 dark:bg-gray-700 rounded-full overflow-hidden">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md dark:shadow-gray-900/10 overflow-hidden transition-all duration-300 hover:shadow-xl dark:hover:shadow-gray-900/20 border border-gray-100 dark:border-gray-700 hover:border-yellow-200 dark:hover:border-yellow-800 group">
                <div className="p-6">
                  ...
                  <div className="mb-5">
                    <div className="flex justify-between mb-2 text-sm">
                      <span className="text-gray-500 dark:text-gray-400 font-medium">Progress</span>
                      <span className="text-gray-700 dark:text-gray-300 font-semibold">28/32 topics</span>
                    </div>
                    <div className="w-full h-3 bg-gray-100 dark:bg-gray-700 rounded-full overflow-hidden">
                  ...
                  <div className="flex justify-between items-center">
                    <span className="inline-flex items-center text-sm font-medium text-gray-600 dark:text-gray-300 bg-yellow-50 dark:bg-yellow-900/30 px-3 py-1 rounded-full">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1 text-yellow-500 dark:text-yellow-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" />
                      </svg>
                      Excellent
                    </span>
              ...
              <div className="px-6 py-5 border-b border-gray-100 dark:border-gray-700 bg-gradient-to-r from-purple-50 to-purple-100 dark:from-purple-900/30 dark:to-purple-800/30">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-0.5">You're on a 5-day streak! Keep it up to earn bonus points.</p>
                  </div>
                </div>
              </div>
              <div className="p-6">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg dark:shadow-gray-900/10 overflow-hidden sticky top-8 border border-gray-100 dark:border-gray-700">
                ...
                <div className="px-6 py-6 border-b border-gray-100 dark:border-gray-700 text-center relative bg-gradient-to-b from-white to-gray-50 dark:from-gray-800 dark:to-gray-850">
                  <div className="absolute top-0 right-0 p-2">
                    <Link href="/profile" className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors duration-200">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                  ...
                  <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">Student Name</h2>
                  <p className="text-sm text-gray-500 dark:text-gray-400">Physics, Chemistry, Combined Math</p>
                  
                  <div className="mt-4 grid grid-cols-3 divide-x divide-gray-100 dark:divide-gray-700">
                    <div className="px-2 text-center group">
                      <div className="text-lg font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-400 dark:from-blue-500 dark:to-blue-300 group-hover:from-blue-500 group-hover:to-blue-300 dark:group-hover:from-blue-400 dark:group-hover:to-blue-200 transition-all duration-300">75%</div>
                      <div className="text-xs text-gray-500 dark:text-gray-400">Physics</div>
                    </div>
                    <div className="px-2 text-center group">
                      <div className="text-lg font-bold text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-green-400 dark:from-green-500 dark:to-green-300 group-hover:from-green-500 group-hover:to-green-300 dark:group-hover:from-green-400 dark:group-hover:to-green-200 transition-all duration-300">62%</div>
                      <div className="text-xs text-gray-500 dark:text-gray-400">Chemistry</div>
                    </div>
                    <div className="px-2 text-center group">
                      <div className="text-lg font-bold text-transparent bg-clip-text bg-gradient-to-r from-yellow-600 to-yellow-400 dark:from-yellow-500 dark:to-yellow-300 group-hover:from-yellow-500 group-hover:to-yellow-300 dark:group-hover:from-yellow-400 dark:group-hover:to-yellow-200 transition-all duration-300">88%</div>
                ...
                <div className="px-6 py-6 border-b border-gray-100 dark:border-gray-700">
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-4 flex-1">
                      <div className="flex justify-between mb-1">
                        <span className="font-medium text-gray-700 dark:text-gray-300">Level 15</span>
                  ...
                  <div className="mt-4">
                    <div className="text-sm text-gray-500 dark:text-gray-400">
                      <span className="font-medium text-gray-700 dark:text-gray-300">550 points</span> until next level
                    </div>
                  </div>
                </div>
                  ...
                  <div className="bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20 rounded-lg p-4 shadow-sm border border-purple-100/50 dark:border-purple-800/30 hover:shadow-md transition-all duration-200 group">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <div className="text-sm text-gray-500 dark:text-gray-400">Top 5% of all students</div>
                      </div>
                      <div className="ml-auto">
                        <Link href="/leaderboard" className="text-purple-600 dark:text-purple-400 hover:text-purple-800 dark:hover:text-purple-300 transition-colors duration-150 group-hover:scale-110 inline-block transform transition-transform duration-200">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div className="px-6 py-6">
                  ...
                  <ul className="space-y-3">
                    <li>
                      <Link href="/profile" className="flex items-center text-gray-700 dark:text-gray-300 hover:text-purple-700 dark:hover:text-purple-400 transition-colors duration-150 p-2 rounded-lg hover:bg-purple-50 dark:hover:bg-purple-900/20 group">
                      <div className="h-8 w-8 rounded-full bg-gray-100 dark:bg-gray-700 flex items-center justify-center text-gray-400 dark:text-gray-500 group-hover:bg-purple-100 group-hover:text-purple-600 dark:group-hover:bg-purple-900/50 dark:group-hover:text-purple-400 transition-colors duration-200">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <li>
                      <Link href="/rewards" className="flex items-center text-gray-700 dark:text-gray-300 hover:text-purple-700 dark:hover:text-purple-400 transition-colors duration-150 p-2 rounded-lg hover:bg-purple-50 dark:hover:bg-purple-900/20 group">
                        <div className="h-8 w-8 rounded-full bg-gray-100 dark:bg-gray-700 flex items-center justify-center text-gray-400 dark:text-gray-500 group-hover:bg-purple-100 group-hover:text-purple-600 dark:group-hover:bg-purple-900/50 dark:group-hover:text-purple-400 transition-colors duration-200">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                          </svg>
                    ...
                    <li>
                      <Link href="/forum" className="flex items-center text-gray-700 dark:text-gray-300 hover:text-purple-700 dark:hover:text-purple-400 transition-colors duration-150 p-2 rounded-lg hover:bg-purple-50 dark:hover:bg-purple-900/20 group">
                        <div className="h-8 w-8 rounded-full bg-gray-100 dark:bg-gray-700 flex items-center justify-center text-gray-400 dark:text-gray-500 group-hover:bg-purple-100 group-hover:text-purple-600 dark:group-hover:bg-purple-900/50 dark:group-hover:text-purple-400 transition-colors duration-200">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <li>
                      <Link href="/settings" className="flex items-center text-gray-700 dark:text-gray-300 hover:text-purple-700 dark:hover:text-purple-400 transition-colors duration-150 p-2 rounded-lg hover:bg-purple-50 dark:hover:bg-purple-900/20 group">
                        <div className="h-8 w-8 rounded-full bg-gray-100 dark:bg-gray-700 flex items-center justify-center text-gray-400 dark:text-gray-500 group-hover:bg-purple-100 group-hover:text-purple-600 dark:group-hover:bg-purple-900/50 dark:group-hover:text-purple-400 transition-colors duration-200">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <li>
                      <Link href="/help" className="flex items-center text-gray-700 dark:text-gray-300 hover:text-purple-700 dark:hover:text-purple-400 transition-colors duration-150 p-2 rounded-lg hover:bg-purple-50 dark:hover:bg-purple-900/20 group">
                        <div className="h-8 w-8 rounded-full bg-gray-100 dark:bg-gray-700 flex items-center justify-center text-gray-400 dark:text-gray-500 group-hover:bg-purple-100 group-hover:text-purple-600 dark:group-hover:bg-purple-900/50 dark:group-hover:text-purple-400 transition-colors duration-200">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
