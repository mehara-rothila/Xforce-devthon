            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl overflow-hidden mb-10 transform transition-all duration-300 hover:shadow-2xl dark:shadow-lg dark:hover:shadow-xl dark:shadow-gray-900/30">
              ...
              <div className="divide-y divide-gray-100 dark:divide-gray-700">
                {categories.map((category) => (
                  <div
                    key={category.id}
                    className={`p-6 transition-all duration-300 ${hoveredCategory === category.id ? 'bg-gray-50 dark:bg-gray-700' : 'dark:bg-gray-800'}`}
                    ...
                    <Link href={`/forum/category/${category.id}`} className="block">
                      <div className="flex items-start">
                        ...
                        <div className="flex-1 min-w-0">
                          <h3 className={`text-lg font-semibold transition-colors duration-200 ${hoveredCategory === category.id ? `text-${category.color}-600 dark:text-${category.color}-400` : 'text-gray-900 dark:text-gray-100'}`}>
                            {category.name}
                          </h3>
                          <p className="mt-1 text-gray-600 dark:text-gray-400">{category.description}</p>
                          <div className="mt-3 flex items-center text-sm">
                            <span className="px-3 py-1 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-full mr-3 font-medium">{category.topics} topics</span>
                            <span className="px-3 py-1 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-full font-medium">{category.posts} posts</span>
                          </div>
                        </div>
                        <div className={`ml-4 transition-transform duration-300 ${hoveredCategory === category.id ? 'transform translate-x-2' : ''}`}>
                          <div className={`w-8 h-8 rounded-full flex items-center justify-center bg-gray-100 dark:bg-gray-700 transition-colors duration-300 ${hoveredCategory === category.id ? `bg-${category.color}-100 text-${category.color}-600 dark:bg-${category.color}-900/30 dark:text-${category.color}-400` : 'text-gray-400 dark:text-gray-500'}`}>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl overflow-hidden transform transition-all duration-300 hover:shadow-2xl dark:shadow-lg dark:hover:shadow-xl dark:shadow-gray-900/30">
              ...
              <div className="divide-y divide-gray-100 dark:divide-gray-700">
                {recentDiscussions.map((discussion) => (
                  <div
                    key={discussion.id}
                    className={`p-6 transition-all duration-300 ${hoveredDiscussion === discussion.id ? 'bg-gray-50 dark:bg-gray-700' : 'dark:bg-gray-800'}`}
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center">
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center">
                            ...
                            <h3 className={`text-lg font-semibold transition-colors duration-200 ${hoveredDiscussion === discussion.id ? 'text-purple-600 dark:text-purple-400' : 'text-gray-900 dark:text-gray-100'}`}>
                              {discussion.title}
                            </h3>
                          </div>
                          <div className="mt-2 flex items-center text-sm">
                            <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                              discussion.category === 'Physics' ? 'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400' :
                              discussion.category === 'Chemistry' ? 'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400' :
                              discussion.category === 'Combined Mathematics' ? 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400' :
                            ...
                            <div className="ml-3 flex items-center">
                              ...
                              <span className="ml-1.5 text-gray-600 dark:text-gray-400">{discussion.author}</span>
                            </div>
                          </div>
                        </div>
                        <div className="mt-3 sm:mt-0 flex items-center text-sm text-gray-500 dark:text-gray-400 space-x-4">
                          <div className="flex items-center">
                            <div className={`p-1.5 rounded-full transition-colors duration-300 ${
                              hoveredDiscussion === discussion.id ? 'bg-purple-100 dark:bg-purple-900/30' : 'bg-gray-100 dark:bg-gray-700'
                            }`}>
                              <svg xmlns="http://www.w3.org/2000/svg" className={`h-4 w-4 transition-colors duration-300 ${
                                hoveredDiscussion === discussion.id ? 'text-purple-600 dark:text-purple-400' : 'text-gray-500 dark:text-gray-400'
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-xl overflow-hidden transition-all duration-300 hover:shadow-2xl dark:shadow-lg dark:hover:shadow-xl dark:shadow-gray-900/30">
              ...
              <div className="p-6">
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  <button className="px-3 py-1.5 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-full text-sm hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors duration-200">
                    #physics
                  </button>
                  <button className="px-3 py-1.5 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-full text-sm hover:bg-gray-200 dark:hover:bg-gray-600 transition-colors duration-200">
                    #chemistry
                ...
                <div className="space-y-5">
                  <div className="relative">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="font-semibold text-gray-900 dark:text-gray-100">558</span>
                    </div>
                  ...
                  <div className="relative">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="font-semibold text-gray-900 dark:text-gray-100">6,756</span>
                    </div>
                    <div className="h-2 bg-gray-100 dark:bg-gray-700 rounded-full overflow-hidden">
                  ...
                  <div className="relative">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="font-semibold text-gray-900 dark:text-gray-100">2,845</span>
                    </div>
                    <div className="h-2 bg-gray-100 dark:bg-gray-700 rounded-full overflow-hidden">
