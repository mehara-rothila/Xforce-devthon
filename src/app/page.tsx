  ...
  return (
    <main className="flex min-h-screen flex-col">
      ...
      <section className="relative overflow-hidden py-24 px-6 min-h-[90vh] flex items-center">
        <div className="absolute inset-0 bg-gradient-to-br from-purple-800 via-purple-700 to-indigo-900"></div>
      ...
      <section className="py-20 px-6 bg-white scroll-mt-16" id="features">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="group bg-white p-8 rounded-xl shadow-md hover:shadow-game transition-all duration-300 transform hover:-translate-y-1 border border-gray-100 hover:border-purple-100 relative overflow-hidden">
      ...
      <section className="py-20 px-6 bg-gray-50 relative scroll-mt-16">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 hover:border-blue-200 text-center relative overflow-hidden group border border-gray-100">
            ...
            <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 hover:border-green-200 text-center relative overflow-hidden group border border-gray-100">
            ...
            <div className="bg-white p-8 rounded-xl shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 hover:border-yellow-200 text-center relative overflow-hidden group border border-gray-100">
      ...
      <section className="py-20 px-6 bg-white scroll-mt-16">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-8 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100 hover:border-purple-100">
