        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden mb-8">
          <div className="p-6">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
              {/* Subject Filters */}
              <div>
                <h3 className="text-sm font-medium text-gray-500 mb-3">Filter by Subject</h3>
              ...
              {/* Difficulty Filters */}
              <div>
                <h3 className="text-sm font-medium text-gray-500 mb-3">Filter by Difficulty</h3>
                <div className="flex flex-wrap gap-2">
                  <button 
              ...
              <div className="flex-shrink-0">
                ...
                <select
                  ...
                  className="bg-white border border-gray-300 rounded-lg px-4 py-2 text-gray-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition-all duration-200 cursor-pointer"
                >
          ...
          {sortedQuizzes.map((quiz: Quiz) => (
            ...
            >
              <div className="p-6">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between text-sm text-gray-600 mb-6 pt-3 border-t border-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:border-purple-200 hover:shadow-xl transition-all duration-300">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <h4 className="text-sm font-medium text-gray-900">Quick Thinker</h4>
                  <p className="text-xs text-gray-500">Complete quiz 50% faster than average</p>
                </div>
              </div>
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <h4 className="text-sm font-medium text-gray-900">Sharpshooter</h4>
                  <p className="text-xs text-gray-500">90%+ accuracy on 5 consecutive quizzes</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:border-purple-200 hover:shadow-xl transition-all duration-300">
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="flex justify-between items-center mb-1">
                  <span className="text-sm font-medium text-gray-700">Combined Math</span>
