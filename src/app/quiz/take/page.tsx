...
export default function TakeQuiz() {
  ...
  const quizId = searchParams?.get('id') || null;
  ...
  // Render logic with fallback for static export
  if (!quizId) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 flex items-center justify-center p-4">
        <div className="bg-white p-8 rounded-xl shadow-lg max-w-md w-full text-center">
          <h2 className="text-2xl font-bold text-gray-800 mb-4">No Quiz Selected</h2>
          <p className="text-gray-600 mb-6">Please select a quiz to take.</p>
              ...
              <div className="px-4 sm:px-6 py-4 bg-gray-50 border-t border-gray-100 flex flex-col sm:flex-row justify-between items-center gap-3">
                ...
                <div className="flex w-full sm:w-auto space-x-3">
                  ...
                  {currentQuestion < quizData.questions.length - 1 ? (
                    ...
                    >
                      Next
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-1.5" fill="none" viewBox="0 0 24  Enforcement24" stroke="currentColor">
