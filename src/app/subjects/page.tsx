      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white shadow-lg rounded-xl overflow-hidden mb-10">
          <div className="md:flex">
            <div className="md:flex-shrink-0 bg-gradient-to-r from-blue-500 to-blue-600 w-full md:w-48 h-48 md:h-auto"></div>
            <div className="p-8">
              <div className="flex items-center">
                ...
                <h2 className="ml-4 text-3xl font-bold text-gray-900">Physics</h2>
              </div>
        ...
        <div className="bg-white shadow-lg rounded-xl overflow-hidden mb-10">
          <div className="md:flex">
            <div className="md:flex-shrink-0 bg-gradient-to-r from-green-500 to-green-600 w-full md:w-48 h-48 md:h-auto"></div>
            <div className="p-8">
              <div className="flex items-center">
                ...
                <h2 className="ml-4 text-3xl font-bold text-gray-900">Chemistry</h2>
              </div>
              <p className="mt-4 text-lg text-gray-600">
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      ...
                      <span>Chemical Reactions Database</span>
                    </li>
                    <li className="flex items-start">
                      <svg className="h-5 w-5 text-green-500 mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path>
                    ...
                    <li className="flex items-start">
                      ...
                      <span>Molecular Structure Visualizer</span>
                    </li>
                  </ul>
                </div>
              </div>
        ...
        <div className="bg-white shadow-lg rounded-xl overflow-hidden mb-10">
          <div className="md:flex">
            <div className="md:flex-shrink-0 bg-gradient-to-r from-yellow-500 to-yellow-600 w-full md:w-48 h-48 md:h-auto"></div>
            <div className="p-8">
              <div className="flex items-center">
                ...
                <h2 className="ml-4 text-3xl font-bold text-gray-900">Combined Mathematics</h2>
              </div>
              <p className="mt-4 text-lg text-gray-600">
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start">
                      ...
                      <span>Step-by-Step Problem Solvers</span>
                    </li>
                    <li className="flex items-start">
                      <svg className="h-5 w-5 text-yellow-500 mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path>
                      </svg>
                      <span>Interactive Graphing Tools</span>
                    </li>
                    <li className="flex items-start">
                      <svg className="h-5 w-5 text-yellow-500 mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path>
                      </svg>
                      <span>Formula Sheets & Cheat Sheets</span>
                    </li>
                    <li className="flex items-start">
                      <svg className="h-5 w-5 text-yellow-500 mr-2 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path>
                      </svg>
                      <span>Video Solutions to Past Papers</span>
                    </li>
                  </ul>
                </div>
              </div>
